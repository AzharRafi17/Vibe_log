        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none resize-none bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
              rows={4}
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  key={star}
              ...
              <span className="text-lg font-bold text-gray-700 dark:text-gray-300 ml-3">
                {rating}/5
              </span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={!text.trim()}
            className={`w-full py-4 rounded-2xl font-bold text-white bg-gradient-to-r ${moodConfig[mood].gradient} shadow-xl hover:shadow-2xl transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            Update Affirmation
          </button>
        </div>
