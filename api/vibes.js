...
// 1. Get Supabase Secrets from Vercel Environment Variables
// These variables must be set in your Vercel project settings!
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL;
const supabaseServiceRoleKey = process.env.SUPABASE_SERVICE_ROLE_KEY; 

// 2. Initialize Supabase Client with the SECURE Service Role Key
// WARNING: Do NOT use the standard anon key here.
    ...
    try {
        ...
        switch (operation) {
            ...
            case 'CREATE':
                ...
                break;
            case 'UPDATE':
                query = query.update(payload.data).eq('id', payload.id);
                break;
            case 'DELETE':
